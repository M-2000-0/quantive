#!/usr/bin/env python3
"""Test Week 2: Direct SuccessFeeCalculator usage"""
...
async def main():
    ...
    # Call the async static method directly
    result = await SuccessFeeCalculator.calculate_fee(
    ...
    result2 = await SuccessFeeCalculator.calculate_fee(
        baseline_cost=Decimal('6420000000'),
    ...
    print(f"  reason: {result2['reason'][:50]}...")
    print(f"  fee: ${result2['fee']}")
    
    # Test 3: No savings
    result3 = await SuccessFeeCalculator.calculate_fee(
        baseline_cost=Decimal('6420000000'),
    ...
    print(f"  reason: {result3['reason'][:40]}...")
    print(f"  fee: ${result3['fee']}")
    
    # Test 4: Fee cap
    result4 = await SuccessFeeCalculator.calculate_fee(
        baseline_cost=Decimal('6420000000'),
