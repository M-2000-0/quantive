      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="glass-strong rounded-[24px] p-8 relative overflow-hidden">
          ...
          <div className="relative">
            <h2 className="text-[17px] font-semibold tracking-tight text-slate-900 mb-1">Create your account</h2>
            <p className="text-sm text-slate-500 mb-6">Request access to the optimization platform</p>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-[12px] font-semibold uppercase tracking-widest text-slate-600 mb-1.5">
                  Full Name
                </label>
                <input
                  id="name"
              ...
              <div>
                <label htmlFor="org" className="block text-[12px] font-semibold uppercase tracking-widest text-slate-600 mb-1.5">
                  Organization Name
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full glass-button-primary text-white text-sm font-semibold rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading && (
