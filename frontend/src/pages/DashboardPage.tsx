        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-sm text-slate-600">Refinancing Risk</span>
                  <span className="text-sm font-semibold text-slate-900 tabular-nums">18%</span>
                </div>
                <div className="w-full bg-slate-100 rounded-full h-1.5">
                  <div className="bg-blue-600 rounded-full h-1.5" style={{ width: '18%' }} />
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-sm text-slate-600">Interest Rate Exposure</span>
                  <span className="text-sm font-semibold text-slate-900 tabular-nums">22%</span>
                </div>
                <div className="w-full bg-slate-100 rounded-full h-1.5">
                  <div className="bg-amber-500 rounded-full h-1.5" style={{ width: '22%' }} />
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-sm text-slate-600">Currency Exposure</span>
                  <span className="text-sm font-semibold text-slate-900 tabular-nums">15%</span>
                </div>
                <div className="w-full bg-slate-100 rounded-full h-1.5">
                  <div className="bg-emerald-500 rounded-full h-1.5" style={{ width: '15%' }} />
                </div>
              </div>
            </div>
          </Card>
            ...
            {completedJobs.length > 0 ? (
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-emerald-700 tabular-nums">{improvementPct}%</span>
                </div>
                <div className="flex items-center justify-between">
          ...
          <div className="col-span-2">
            <Card padding={false}>
              <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                <div>
                  <h3 className="text-base font-semibold text-slate-900">Portfolios</h3>
                ...
                <div className="divide-y divide-slate-100">
                  {portfolios.map((p) => (
                    ...
                    >
                      ...
                      <div className="ml-4 text-sm font-semibold text-slate-900 tabular-nums">
