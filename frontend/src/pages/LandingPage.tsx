...
const FEATURES = [
  ...
  { icon: Globe, title: 'Global Market Data', desc: 'Live Treasury yields, ECB FX rates, IMF macro indicators — zero API keys.' },
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              ...
              <h2 style={{ fontSize: 18, fontWeight: 600 }}>Qubo — AI Tax Intelligence</h2>
            </div>
            <p style={{ fontSize: 14, color: 'var(--text2)', lineHeight: 1.6, marginBottom: 16 }}>
              Finds deductions, categorizes every transaction, and preps your return —
