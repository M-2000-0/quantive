      ...
      {!open && (
        <button
          ...
          style={{
            ...
            background: 'linear-gradient(135deg, #f5f5f3, #c7c7cc)',
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <MessageCircle size={16} color="#e8e8ea" />
              <div>
              ...
              {conversations.map((c) => (
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{
                      color: c.id === conversationId ? '#e8e8ea' : '#e5e7eb',
                  ...
                  {SUGGESTIONS.map((s) => (
                    <button
                      ...
                      style={{
                        ...
                        color: '#e8e8ea', fontSize: 12, cursor: 'pointer',
                      }}
                    >
                      {s}
                    </button>
            ...
            {messages.map((m, i) => (
              <div key={i} style={{ marginBottom: 12 }}>
                <div style={{
                  ...
                  color: m.role === 'user' ? '#9ca3af' : '#e8e8ea', marginBottom: 4,
                }}>
                  ...
                  <div style={{ display: 'none', marginTop: 6 }}>
                    {m.sources.slice(0, 5).map((s, j) => (
                      <div key={j} style={{
                        ...
                        borderLeft: '2px solid #e8e8ea', marginBottom: 4, background: '#0d0f13',
                      }}>
                        <div style={{ color: '#e8e8ea', fontSize: 10, marginBottom: 2 }}>
          ...
          >
            ...
            <button
              ...
              style={{
                background: loading || !input.trim() ? '#23272e' : '#e8e8ea',
