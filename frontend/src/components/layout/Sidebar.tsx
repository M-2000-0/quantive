    ...
    <>
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b border-slate-800 px-5">
          ...
          <div>
            <span className="text-sm font-semibold tracking-wide text-white">QUANTIVE</span>
            <p className="text-[10px] font-medium tracking-widest text-slate-400">DEBT OPTIMIZER</p>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 px-5 py-4">
          ...
          <p className="mt-1.5 text-[11px] text-slate-600">v2.1.0</p>
        </div>
      </aside>
    </>
  );
